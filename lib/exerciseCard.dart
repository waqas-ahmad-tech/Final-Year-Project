        ...
        child: Column(
          children: [
            if(widget.bmiCategory=="Underweight")...[
              ...
              customExercise(exerciseTitle: 'Burpee', path: 'assets/Healthy Exercises/burpee.gif'),
              ...
              customExercise(exerciseTitle: 'Downward Facing Dog Stretching', path: 'assets/Healthy Exercises/Downward Facing Dog Stretching.gif'),
              ...
              customExercise(exerciseTitle: 'Push Up', path: 'assets/Healthy Exercises/Push Up.gif'),
                ...
                customExercise(exerciseTitle: 'resistance band hipabduction', path: 'assets/Exercise/resistance band hipabduction.gif'),
